...
\lstinline|\labelcref{Label}|& 	Nummer/Wert &\labelcref{sec:latex-verweise}\\
\lstinline|\labelcpageref{Label}|&	Nur die Seitenzahl&\labelcpageref{sec:latex-verweise}\\
\end{tabular}
\end{center}
...
\subsubsection{Ein Beispiel mit Zitat}
